...
try {
    ...
    $mail->Password   = $con [smtp_password];                               //SMTP password
    ...
    $mail->addAddress($mailCnt['mail_to'], $mail_Cnt [mail_to]);     //Add a recipient
    ...
    $mail->Body    = 'Welcome to <b>BBIT DevOPs</>! This is a new semester';
